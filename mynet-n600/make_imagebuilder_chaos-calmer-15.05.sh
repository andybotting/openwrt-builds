...
mv -v bin/${TARGET}/openwrt-${VER}-${TARGET}-${ARCH}-mynet-n600-squashfs-sysupgrade.bin ../builds/openwrt-${PROFILE}-${NAME}_${VER}-$(date --iso)-squashfs-sysupgrade-imagebuilder.image
mv -v bin/${TARGET}/openwrt-${VER}-${TARGET}-${ARCH}-mynet-n600-squashfs-factory.bin ../builds/openwrt-${PROFILE}-${NAME}_${VER}-$(date --iso)-squashfs-sysupgrade-imagebuilder-factory.image
